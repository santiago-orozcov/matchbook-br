...
2. Abre `index.html` directamente en el navegador (doble clic, o con la extensión "Live Server" de VS Code para recarga automática).
3. Regístrate con cualquier correo y contraseña — los datos quedan guardados en el `localStorage` de tu navegador.
